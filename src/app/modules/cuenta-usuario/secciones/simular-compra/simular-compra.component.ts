...
@Component({
  ...
  styleUrls: ['./simular-compra.component.css']
})
export class SimularCompraComponent {
  monto: number=0;
    ...
    let pasa = true;
     if (this.monto <= 0) {
      ...
      this.util.enviarAlerta(
        ...
        this.util.colorWarning,
        'Error en el formulario',
        'Formato en el campo concepto no puede ser vacio'
      );
      ...
      this.util.enviarAlerta(
        ...
        this.util.colorWarning,
        'Error en el formulario',
        'Formato en el campo descripcion no puede ser vacio'
      );
    }
